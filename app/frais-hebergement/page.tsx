      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-medium">
            Frais d’hébergement au réel dans la limite des sommes indiquées
            ci-dessous
          </h3>
        </div>
        <Separator />
        <div>
          <ul className="list-disc pl-5 space-y-8">
            <li>
              ...
              juillet 2023 = 120 € par nuit / 12 € par petit déjeuner) en annexe
              la liste des partenariat et lien sur SharePoint
              <span>
                De nombreux hôtels proposent des formules d’hébergement tous
                compris (chambre + repas + petit déjeuner) que la société
                préconise d’utiliser.
              </span>
            </li>
            <li>
              Les dépenses de mini bar, de blanchisserie (hormis pour les
              déplacements de plus de 7 jours) et d’appels téléphoniques
              personnels passés des hôtels ne sont pas pris en compte.
            </li>
            <li>
          ...
          <div className="mt-6">
            ...
            <ul className="list-disc pl-5 space-y-4">
              ...
              <li>
                Offre disponible dans plus de 3500 hôtels en France et à
                l'étranger
              </li>
              <li>
